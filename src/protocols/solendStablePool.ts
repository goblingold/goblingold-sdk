...
export async function initializeProtocol(
  ...
  const vaultSolendStablePoolCollateralTokenAccount =
  ...
  vaultKeys.vaultSolendStablePoolCollateralTokenAccount =
    vaultSolendStablePoolCollateralTokenAccount;
  if (
...
export async function setHashes(
  ...
  const depositData = new Uint8Array([
    ...vaultKeys.vaultSolendStablePoolCollateralTokenAccount.toBytes(),
  ...
  return program.methods
    .setHashes(Protocols.SolendStablePool, hashes)
    .accounts({
